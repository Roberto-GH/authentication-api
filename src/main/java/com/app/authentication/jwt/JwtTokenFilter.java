...
import com.app.authentication.security.UserDetailsServiceImpl;
...
public class JwtTokenFilter extends OncePerRequestFilter {
  ...
  private final static Logger _log = LoggerFactory.getLogger(JwtTokenFilter.class);
  ...
  protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain)
    ...
    try {
      ...
      _log.error("Fallo en el metodo doFilter");
    }
